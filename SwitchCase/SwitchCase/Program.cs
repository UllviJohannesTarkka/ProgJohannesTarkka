...
namespace SwitchCase
{
    class MainClass
    {
        public static void Main(string[] args)
        {
            while (true)
            {
                Console.WriteLine("Välkommen! Välj ett alternativ nedan:");
                Console.Write("1: Skriv ut en fin dikt\n" +
                              "2: Skriv ut namnet på daddy\n" +
                              "3: Skriv ut ett skämt\n");

                string Nogger = Console.ReadLine();

                int val = int.Parse(Nogger);

                switch (val)
                {
                    case 1:
                        Console.WriteLine("Rosor är röda violer är blå Jacob suger på OW");
                        break;
